<div class="content-wrapper">
  <section class="content-header">
    <h1>
      <span class="title-page"><?= "Petugas Aftar"?></span>
          ...
          <div class="box-body">
            ...
            <table id="tablelist" class="table table-bordered table-striped" style="width: 100%">
              <thead>
                <tr>
                  <th style="width:3%"></th>
                  <th style='width:20%'>Nama Petugas Aftar</th> 
<th style='width:20%'>No HP Petugas Aftar</th> 
<th style='width:20%'>Alamat Petugas Aftar</th> 
...
<script src="<?= base_url("controller") ?>/petugasaftar.js"></script>